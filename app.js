...
// endpoint for getting reserved seats for a screening
...
// endpoint for getting booked seats for a screening
...
// endpoint for getting a screening by id
...
// endpoint for getting earnings for a screening
...
// endpoint for posting a new screening
...
// endpoint for deleting a screening
...
// endpoint for getting a specific hall
...
// endpoint for creating a new seating category
...
// endpoint for fetching all seating categories
...
// endpoint for creating a new hall
...
// endpoint for fetching a hall by ID
app.get('/hall/:hallId', function(req, res, next) {
    hallAPICalls.getHallById(req.params.hallId).then(data => {
        res.send(data);
    });
...
// endpoint for deleting a hall by ID
...
// endpoint for adding rows to a hall
...
// endpoint for updating a row in a hall
...
// endpoint for getting all halls
...
// endpoint for adding a reservation for a customer
...
// endpoint for getting all reservations for a customer
...
// endpoint for deleting a reservation for a customer
...
// endpoint for transforming a reservation into a booking
...
// endpoint for getting all bookings for a customer
...
// endpoint for adding a new booking to a customer
...
//endpoint for deleting a booking for a customer
